...
export default {
  ...
  "Sign in": "Sign in",
  Register: "Register",
  "Password Changed": "Password reset successful",
  Password: "Password*",
  "New Password": "New Password*",
  "Repeat Password": "Repeat Password",
  "Forgot Password Modal Email": "Email address",
  forgotPasswordConfirmation: "Check your email {0} and open the link we sent to continue.",
  ...
  cardNumberInvalid: "Invalid credit card number",
  expiryDateInvalid: "Invalid expiration date",
  cvvInvalid: "Invalid CVV",
  expiryDateInvalidFormat: "Provide Expiration Date as MM/YYYY",
  "Order Summary": "Order Summary",
  ...
  checkOrderStatus: "Checking the status of your order is fast and simple!",
  enterOrderNumberAndBillingEmail:
